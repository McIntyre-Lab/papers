...
proc means data=all_gene_info noprint;
   var flag_CD19_on flag_CD4_on flag_CD8_on flag_fusion_all_on0 flag_p05_cd4_cd8 flag_cd4cd8_fdr05 flag_p05_cd4_cd19 flag_cd4cd19_fdr05 flag_p05_cd8_cd19 flag_cd8cd19_fdr05 exon_count;
   by gene_id ;
...
proc means data=all_gene_info noprint;
   ...
   output out=gene_info_collapsed_CD19 sum=;
run;
...
proc means data=all_gene_info noprint;
   ...
   output out=gene_info_collapsed_CD4 sum=;
run;
...
proc means data=all_gene_info noprint;
   ...
   output out=gene_info_collapsed_CD8 sum=;
run;
...
proc means data=all_gene_info noprint;
   ...
   output out=gene_info_collapsed_CD4CD19 sum=;
run;
...
proc means data=all_gene_info noprint;
   ...
   output out=gene_info_collapsed_CD8CD19 sum=;
run;
...
proc means data=all_gene_info noprint;
   ...
   output out=gene_info_collapsed_CD4CD8 sum=;
run;
...
proc sort data=gene_info_collapsed_CD19;
   by gene_id;
run;

proc sort data=gene_info_collapsed_CD4;
   by gene_id;
run;
...
proc sort data=gene_info_collapsed_CD4CD19;
   by gene_id;
run;

proc sort data=gene_info_collapsed_CD8CD19;
   by gene_id;
run;

proc sort data=gene_info_collapsed_CD4CD8;
   by gene_id;
run;
...
data gene_info_collapsed_CD19_2 no_CD19 oops;
   merge gene_info_collapsed_CD19 (in=in1) gene_info_collapsed2 (in=in2);
   by gene_id;
   if in1 and in2 then output gene_info_collapsed_CD19_2;
   else if in2 then output no_CD19;
   else output oops;
run;

data gene_info_collapsed_CD4_2 no_CD4 oops;
   merge gene_info_collapsed_CD4 (in=in1) gene_info_collapsed2 (in=in2);
   by gene_id;
   if in1 and in2 then output gene_info_collapsed_CD4_2;
   else if in2 then output no_CD4;
   else output oops;
run;

data gene_info_collapsed_CD8_2 no_CD8 oops;
   merge gene_info_collapsed_CD8 (in=in1) gene_info_collapsed2 (in=in2);
   by gene_id;
   if in1 and in2 then output gene_info_collapsed_CD8_2;
   else if in2 then output no_CD8;
   else output oops;
run;


data gene_info_collapsed_CD4CD8_2 no_CD4CD8 oops;
   merge gene_info_collapsed_CD4CD8 (in=in1) gene_info_collapsed2 (in=in2);
   by gene_id;
   if in1 and in2 then output gene_info_collapsed_CD4CD8_2;
   else if in2 then output no_CD4CD8;
   else output oops;
run;

data gene_info_collapsed_CD4CD19_2 no_CD4CD19 oops;
   merge gene_info_collapsed_CD4CD19 (in=in1) gene_info_collapsed2 (in=in2);
   by gene_id;
   if in1 and in2 then output gene_info_collapsed_CD4CD19_2;
   else if in2 then output no_CD4CD19;
   else output oops;
run;

data gene_info_collapsed_CD8CD19_2 no_CD8CD19 oops;
   merge gene_info_collapsed_CD8CD19 (in=in1) gene_info_collapsed2 (in=in2);
   by gene_id;
   if in1 and in2 then output gene_info_collapsed_CD8CD19_2;
   else if in2 then output no_CD8CD19;
   else output oops;
run;
...
data exons_exp_both;
   ...
   keep gene_id flag_fusion_all_on0;
run;

data exons_exp_CD19;
   set gene_info_collapsed_CD19_2;
   keep gene_id flag_CD19_on;
run;

data exons_exp_CD4;
   set gene_info_collapsed_CD4_2;
   keep gene_id flag_CD4_on;
run;

data exons_exp_CD8;
   set gene_info_collapsed_CD8_2;
   keep gene_id flag_CD8_on;
run;

data exons_exp_CD4CD8;
   set gene_info_collapsed_CD4CD8_2;
   keep gene_id flag_CD4_on;
   rename flag_CD4_on=flag_CD4CD8_on;

run;

data exons_exp_CD4CD19;
   set gene_info_collapsed_CD4CD19_2;
   keep gene_id flag_CD4_on;
   rename flag_CD4_on=flag_CDCD19_on;

run;

data exons_exp_CD8CD19;
   set gene_info_collapsed_CD8CD19_2;
   keep gene_id flag_CD8_on;
   rename flag_CD8_on=flag_CD8CD19_on;
run;
...
data exp_gene_info_w_exons no_exp;
   merge gene_info_collapsed_exp2 (in=in1) exons_by_gene_exp (in=in2);
   by gene_id;
...
data con.results_gene_summary con.non_expressed_gene oops;
   merge exp_gene_info_w_exons (in=in1) gene_info_collapsed (in=in2);
   by gene_id;
   if in1 and in2 then output con.results_gene_summary;
   else if in2 then output con.non_expressed_gene ;
   else output oops;
   drop _TYPE_ _FREQ_;
run;
