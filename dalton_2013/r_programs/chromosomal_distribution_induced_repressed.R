...
INPUT <- paste(REPORTS,"chrom_enrichment_tables.csv",sep="/")
...
svg(paste(REPORTS,"/chrom_dist/female_induced.svg",sep=""))
...
svg(paste(REPORTS,"/chrom_dist/male_induced.svg",sep=""))
...
svg(paste(REPORTS,"/chrom_dist/female_repressed.svg",sep=""))
...
svg(paste(REPORTS,"/chrom_dist/male_repressed.svg",sep=""))
