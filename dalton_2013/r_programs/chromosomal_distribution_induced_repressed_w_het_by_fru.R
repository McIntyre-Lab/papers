...
INPUT <- paste(REPORTS,"chrom_enrichment_tables_w_het_by_fru.csv",sep="/")
...
svg(paste(REPORTS,"/chrom_dist/female_fru_a_ind_w_het.svg",sep=""))
...
svg(paste(REPORTS,"/chrom_dist/female_fru_b_ind_w_het.svg",sep=""))
...
svg(paste(REPORTS,"/chrom_dist/female_fru_c_ind_w_het.svg",sep=""))
...
svg(paste(REPORTS,"/chrom_dist/male_fru_a_ind_w_het.svg",sep=""))
...
svg(paste(REPORTS,"/chrom_dist/male_fru_b_ind_w_het.svg",sep=""))
...
svg(paste(REPORTS,"/chrom_dist/male_fru_c_ind_w_het.svg",sep=""))
...
svg(paste(REPORTS,"/chrom_dist/female_fru_a_rep_w_het.svg",sep=""))
...
svg(paste(REPORTS,"/chrom_dist/female_fru_b_rep_w_het.svg",sep=""))
...
svg(paste(REPORTS,"/chrom_dist/female_fru_c_rep_w_het.svg",sep=""))
...
svg(paste(REPORTS,"/chrom_dist/male_fru_a_rep_w_het.svg",sep=""))
...
svg(paste(REPORTS,"/chrom_dist/male_fru_b_rep_w_het.svg",sep=""))
...
svg(paste(REPORTS,"/chrom_dist/male_fru_c_rep_w_het.svg",sep=""))
