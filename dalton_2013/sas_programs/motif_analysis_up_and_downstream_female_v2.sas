...
%macro enrichment_analysis(letter);
        ...
        proc freq data=ind_rep_motif noprint;
            tables flag_female_&letter.*flag_fru_&letter._motif /chisq expected outexpect out=fru_female_&letter._motif;
            exact fisher chisq;
...
data FRU.fru_motif_test_up_down_female_v2;
...
%macro export_analysis(letter,outdir);
        ...
        proc export data=fru_female_&letter._motif 
                    outfile="&outdir./fru_&letter._motif_table_up_and_down_female_v2.csv" 
...
proc export data=FRU.fru_motif_test_up_down_female_v2
            outfile="!MCLAB/arbeitman/arbeitman_fru_network/reports_internal/motif_analysis/motif_results_up_and_down/fru_motif_tests_up_and_down_female_v2.csv" 
            dbms=CSV replace label;
    putnames=yes;
    run;
...
proc datasets;
    ...
    FRU_C_MOTIF_TEST FRU_FEMALE_A_MOTIF FRU_FEMALE_B_MOTIF FRU_FEMALE_C_MOTIF
    IND_REP_MOTIF ;
    run;
