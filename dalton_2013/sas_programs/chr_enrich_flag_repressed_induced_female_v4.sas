...
%rename_var1(fru.female_induced_union);
%rename_var1(fru.female_repressed_union);
...
%sort_fbgn(fru.female_induced_union);
%sort_fbgn(fru.female_repressed_union);
...
data all_merged oops oops2;
    merge fru.female_induced_union (in=in1) fru.female_repressed_union (in=in2) some_merged (in=in3);
    by primary_fbgn;
...
data fru.flag_x_induced_repressed_female;
...
data fru.flag_ind_rep_w_het_female;
    retain primary_fbgn symbol chrom start end strand;
    set all_merged;
