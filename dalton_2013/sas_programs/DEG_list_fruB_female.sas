...
proc export data=induced
            outfile= '/home/jfear/mclab/arbeitman/arbeitman_fru_network/exported_data_from_michelle/FruM_B_female_ind_jmf.tab'
            dbms=CSV replace;
            putnames=no;
            run;

proc export data=repressed
            outfile= '/home/jfear/mclab/arbeitman/arbeitman_fru_network/exported_data_from_michelle/FruM_B_female_rep_jmf.tab'
            dbms=CSV replace;
            putnames=no;
            run;

data FRU.fruB_female_fusions_ind_rep;
    set merged2;
    rename flag_induced = flag_fruB_female_ind;
    rename flag_repressed = flag_fruB_female_rep;
    keep fusion_id flag_induced flag_repressed;
    run;
