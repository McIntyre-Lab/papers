...
%macro enrichment_analysis(letter);
    ...
    %macro response_type(type);
        ...
        proc freq data=ind_rep_motif noprint;
            tables flag_female_&letter._&type.*flag_fru_&letter._motif /chisq expected outexpect out=fru_&letter._&type._motif;
            exact fisher chisq;
...
data FRU.fru_motif_test_up_down_female;
...
%macro export_analysis(letter,outdir);
    ...
    %macro response_type(type);
        ...
        proc export data=fru_&letter._&type._motif 
                    outfile="&outdir./fru_&letter._&type._motif_table_up_and_down_female.csv" 
...
proc export data=fru.fru_motif_test_up_down_female 
            outfile="!MCLAB/arbeitman/arbeitman_fru_network/reports_internal/motif_analysis/motif_results_up_and_down/fru_motif_tests_up_and_down_female.csv" 
            dbms=CSV replace label;
    putnames=yes;
    run;
