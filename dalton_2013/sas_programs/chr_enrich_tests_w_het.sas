...
%macro export_chi(type);
    proc export data=chisq_&type
                outfile = "!MCLAB/arbeitman_fru_network/reports_external/chrom_enrichment_&type._w_het.csv"
                dbms=CSV replace;
                putnames = yes;
                run;
%mend export_chi;
