...
proc export data=induced
            outfile= '/home/jfear/mclab/arbeitman/arbeitman_fru_network/exported_data_from_michelle/FruM_C_male_ind_jmf.tab'
            dbms=CSV replace;
            putnames=no;
            run;

proc export data=repressed
            outfile= '/home/jfear/mclab/arbeitman/arbeitman_fru_network/exported_data_from_michelle/FruM_C_male_rep_jmf.tab'
            dbms=CSV replace;
            putnames=no;
            run;

data FRU.fruC_male_fusions_ind_rep;
    set merged2;
    rename flag_induced = flag_fruC_male_ind;
    rename flag_repressed = flag_fruC_male_rep;
    keep fusion_id flag_induced flag_repressed;
    run;
