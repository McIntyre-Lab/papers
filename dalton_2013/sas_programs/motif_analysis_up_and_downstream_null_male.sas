...
%macro enrichment_analysis(letter);
    ...
    %macro response_type(type);
        ...
        proc freq data=ind_rep_motif noprint;
            tables flag_null_&type.*flag_motif /chisq expected outexpect out=fru_&letter._&type._motif;
            exact fisher chisq;
    ...
    proc datasets nolist;
        delete Fru_&letter._ind_motif_test Fru_&letter._rep_motif_test;
        run;
...
data FRU.fru_motif_test_up_down_null_male;
...
%macro export_analysis(letter,outdir);
    ...
    %macro response_type(type);
        ...
        proc export data=fru_&letter._&type._motif 
                    outfile="&outdir./fru_&letter._&type._motif_table_up_and_down_null_male.csv" 
...
proc export data=FRU.fru_motif_test_up_down_null_male 
            outfile="!MCLAB/arbeitman/arbeitman_fru_network/reports_internal/motif_analysis/motif_results_up_and_down/fru_motif_tests_up_and_down_null_male.csv" 
            dbms=CSV replace label;
    putnames=yes;
    run;
