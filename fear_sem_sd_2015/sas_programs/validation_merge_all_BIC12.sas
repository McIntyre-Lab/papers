/*******************************************************************************
* Filename: validation_merge_all_BIC12.sas
*
...
/* Merge to Model Design */
    ...
    data design;
        merge SEM.cegsV_ag_w_bic_cutoff (in=in1) SEM.cegsV_ag_model_design_file (in=in2);
        by model;
        if in1;
        run;
...
/* Merge on Chang */
    ...
    data chang oops;
        ...
        by primary_fbgn;
        if in1 then output chang; * 334780 obs;
        else output oops; * 1140 obs;
        run;
...
/* Merge on McIntyre */
    ...
    data mcintyre oops;
        ...
        by primary_fbgn;
        if in1 then output mcintyre; * 334780 obs;
...
/* Merge on Goldman */
    ...
    data goldman oops;
        ...
        by primary_fbgn;
        if in1 then output goldman; * 334780 obs;
        else output oops; * 37 obs;
        run;
...
/* Merge on gene symbol */
    ...
    data merged oops;
        ...
        by primary_fbgn;
        if in1 then output merged; * 334780 obs;
        else output oops; * 220507 obs;
        run;
        
/* Make Perm Dataset */
    data SEM.validation_set_BIC12;
        set merged;
        run; * 334780 obs;
