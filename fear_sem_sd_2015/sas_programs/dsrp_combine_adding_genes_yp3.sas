...
*libname addgen '!MCLAB/cegs_sem_sd_paper/adding_genes/yp3/sas_data';
libname addgen '/home/jfear/tmp/yp3/sas_data';
...
proc printto log='/home/jfear/tmp/yp3.log' new;
run;
...
data SEM.dsrp_adding_genes_yp3_stack_bic;
    set combined;
    run;
...
data SEM.dsrp_adding_genes_yp3_sbs_bic;
