...
/* SEM Gene Covariance */
    options ps = 70 ls=80;
    proc printto LOG='!MCLAB/cegs_sem_sd_paper/analysis_output/sem/cegsV/logs/gene_cov_estimates_yp1.log' PRINT='!MCLAB/cegs_sem_sd_paper/analysis_output/sem/cegsV/gene_cov_model_yp1.lst' NEW;
    run;
    ...
    proc export data=combined outfile='!MCLAB/cegs_sem_sd_paper/analysis_output/sem/cegsV/gene_cov_estimates_yp1.csv' dbms=csv replace;
        putnames=yes;
        run;
