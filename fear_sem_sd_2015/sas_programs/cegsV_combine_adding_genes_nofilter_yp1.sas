...
proc printto log='/home/jfear/tmp/cegv_yp1.log' new; run;
 ...
 * some appending issues. So now genes are in the dataset multiple times. Just
...
/* Create Permanent stacked dataset */
...
data SEM.cegsV_ag_yp1_stack_bic;
    set combined;
    run;

proc transpose data=SEM.cegsV_ag_yp1_stack_bic out=flip;
    by gene;
    var BIC;
    id model;
    run;

data SEM.cegsV_ag_yp1_sbs_bic;
