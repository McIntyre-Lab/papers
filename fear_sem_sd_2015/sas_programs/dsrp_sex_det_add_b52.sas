...
/* BASELINE Gene Covaraince */
    options ps = 70 ls=80;
    proc printto LOG='!MCLAB/cegs_sem_sd_paper/analysis_output/sem/logs/add_b52_estimates.log' PRINT='!MCLAB/cegs_sem_sd_paper/analysis_output/sem/add_b52_estimates.lst' NEW;
    run;
    ...
    * print log and output back to listings;
    ...
    proc export data=combined outfile='!MCLAB/cegs_sem_sd_paper/analysis_output/sem/add_b52_estimates.csv' dbms=csv replace;
    putnames=yes;
    run;
...
/* BASELINE Gene Covaraince */
    ...
    proc calis data=w_sample method=fiml COVARIANCE RESIDUAL MODIFICATION maxiter=10000;
        path
            fl_2_d_A fl_2_d_B Spf45 snf vir -> Sxl_A,
            fl_2_d_A fl_2_d_B b52_A b52_B vir Sxl_A -> tra,
            tra2_A tra2_B tra -> fru,
            tra2_A tra2_B tra her ix -> Yp2,
