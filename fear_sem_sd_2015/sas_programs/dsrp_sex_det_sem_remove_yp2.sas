...
/* SEM Gene Covariance */
    options ps = 70 ls=80;
    proc printto LOG='!MCLAB/cegs_sem_sd_paper/analysis_output/sem/logs/remove_yp2.log' PRINT='!MCLAB/cegs_sem_sd_paper/analysis_output/sem/remove_yp2.lst' NEW;
    run;
    ...
    proc export data=combined outfile='!MCLAB/cegs_sem_sd_paper/analysis_output/sem/remove_yp2.csv' dbms=csv replace;
    putnames=yes;
    run;
