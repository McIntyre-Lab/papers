/*******************************************************************************
* Filename: Makefile_cegs_sem_adding_genes_downstream_dsx.sas
*
...
/* Identify genes added downstream of DSX */
    ...
    *        SEM.cegsV_gene_list
    *
    * DATASET: SEM.cegsV_ag_yp2_flag_ds_dsx
    *
    * FILE: !MCLAB/cegs_sem_sd_paper/analysis_output/adding_genes/cegsV_ag_yp2_flag_ds_dsx.csv
    ;
    %include '!MCLAB/cegs_sem_sd_paper/sas_programs/cegsV_ag_dsx_gene_list_nofilter_yp2.sas';
...
/* Compare DSX list to Luo 2011 */
    ...
    *
    * INPUT: SEM.cegsV_ag_yp2_flag_ds_dsx
    * 
    * DATASET: SEM.luo2011
    ;
    %include '!MCLAB/cegs_sem_sd_paper/sas_programs/cegsV_ag_dsx_compare_luo2011.sas';
...
/* Create list of genes that fit downstream of DSX the best */
    ...
    * DATASET:
    ;
    %include '!MCLAB/cegs_sem_sd_paper/sas_programs/cegsV_ag_dsx_add_multiple_downstream.sas';
