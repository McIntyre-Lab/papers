/*******************************************************************************
* Filename: cegsV_ag_fru_bs_analysis.sas
*
...
/* Grab genes added best downstream of fru */
    data dsfru;
        set SEM.cegsV_ag_yp2_flag_ds_fru;
...
/* Export list with motif count */
    proc export data=merged outfile='!MCLAB/cegs_sem_sd_paper/analysis_output/adding_genes/cegsV_ag_ds_fru_binding_site.csv' dbms=csv replace;
        putnames=yes;
        run;
