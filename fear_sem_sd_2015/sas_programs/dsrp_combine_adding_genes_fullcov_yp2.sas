...
*libname addgen '!MCLAB/cegs_sem_sd_paper/adding_genes/fullcov/sas_data';
libname addgen '/home/jfear/tmp/fullcov/sas_data';
...
proc printto log='/home/jfear/tmp/fullcov.log' new;
run;
...
data SEM.dsrp_adding_genes_fcov_stack_bic;
    set combined;
    run;
...
data SEM.dsrp_adding_genes_fcov_sbs_bic;
...
proc sort data=SEM.dsrp_adding_genes_fcov_stack_bic;
    by bic;
    run;
