...
/* Move Fru to Yp2 */
    options ps = 70 ls=80;
    proc printto LOG='!MCLAB/cegs_sem_sd_paper/analysis_output/sem/logs/move_fru_to_yp2.log' PRINT='!MCLAB/cegs_sem_sd_paper/analysis_output/sem/move_fru_to_yp2.lst' NEW;
    run;
    ...
    proc calis data=w_sample method=fiml COVARIANCE RESIDUAL MODIFICATION maxiter=10000;
        path
            ...
            tra2_A tra2_B tra her ix fru -> Yp2,
    ...
    * print log and output back to listings;
    ...
    proc export data=combined outfile='!MCLAB/cegs_sem_sd_paper/analysis_output/sem/move_fru_to_yp2.csv' dbms=csv replace;
    putnames=yes;
    run;
