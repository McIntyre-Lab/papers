...
*libname addgen '!MCLAB/cegs_sem_sd_paper/adding_genes/truncted/sas_data';
libname addgen '/home/jfear/tmp/truncated/sas_data';

*Get baseline BIC value;
data _null_;
    set SEM.dsrp_sex_det_tgene_cov_model_bic;
...
proc printto log='/home/jfear/tmp/trun.log' new;
run;
...
data SEM.dsrp_adding_genes_trun_stack_bic;
    set combined;
    run;
...
data SEM.dsrp_adding_genes_trunc_sbs_bic;
