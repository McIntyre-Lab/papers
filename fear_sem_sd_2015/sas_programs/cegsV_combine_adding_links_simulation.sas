...
proc printto log="!HOME/tmp/cegs_adding_links_simulation/combine.log" new; run;
%combine_bic();
...
ods graphics on;
ods pdf file="!MCLAB/cegs_sem_sd_paper/analysis_output/simulation/cegs_adding_links_simulation_bic_dist.pdf";
