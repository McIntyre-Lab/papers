...
/* SEM with covarainces between fl(2)d isoforms constrained to 0 */
    options ps = 70 ls=80;
    proc printto LOG='!MCLAB/cegs_sem_sd_paper/analysis_output/sem/logs/fl2d_isoforms_constrained_estimates.log' PRINT='!MCLAB/cegs_sem_sd_paper/analysis_output/sem/fl2d_isoforms_constrained_model.lst' NEW;
    run;
    ...
    proc export data=combined outfile='!MCLAB/cegs_sem_sd_paper/analysis_output/sem/fl2d_isoforms_constrained_estimates.csv' dbms=csv replace;
        putnames=yes;
        run;
