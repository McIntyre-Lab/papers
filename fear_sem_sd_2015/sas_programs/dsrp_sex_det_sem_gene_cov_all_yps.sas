...
/* SEM Gene Covariance */
    options ps = 70 ls=80;
    proc printto LOG='!MCLAB/cegs_sem_sd_paper/analysis_output/sem/logs/gene_cov_all_yps.log' PRINT='!MCLAB/cegs_sem_sd_paper/analysis_output/sem/gene_cov_all_yps.lst' NEW;
    run;
    ...
    proc export data=combined outfile='!MCLAB/cegs_sem_sd_paper/analysis_output/sem/gene_cov_all_yps.csv' dbms=csv replace;
    putnames=yes;
    run;
