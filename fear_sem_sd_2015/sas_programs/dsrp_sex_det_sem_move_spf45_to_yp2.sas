...
/* Move Spf45 To Yp2 */
    options ps = 70 ls=80;
    proc printto LOG='!MCLAB/cegs_sem_sd_paper/analysis_output/sem/logs/move_spf45_to_yp2_estimates.log' PRINT='!MCLAB/cegs_sem_sd_paper/analysis_output/sem/move_spf45_to_yp2_estimates.lst' NEW;
    run;
    ...
    proc calis data=w_sample method=fiml COVARIANCE RESIDUAL MODIFICATION maxiter=10000;
        path
            ...
            Spf45 tra2_A tra2_B tra her ix -> Yp2,
    ...
    * print log and output back to listings;
    ...
    proc export data=combined outfile='!MCLAB/cegs_sem_sd_paper/analysis_output/sem/move_spf45_to_yp2_estimates.csv' dbms=csv replace;
    putnames=yes;
    run;
