...
/* Pull out factors and create a summary dataset */
    ...
    proc export data=flag_factor outfile='!MCLAB/cegs_sem_sd_paper/analysis_output/factor/cegsV_sex_det_factor_analysis_fusions.csv' dbms=csv replace;
        putnames=yes;
        run;
...
data _null_;
    call system('python $MCLAB/cegs_sem_sd_paper/scripts/plot_fa_grid.py --factor $MCLAB/cegs_sem_sd_paper/analysis_output/factor/cegsV_sex_det_factor_analysis_fusions.csv -o $MCLAB/cegs_sem_sd_paper/analysis_output/factor/cegsV_sex_det_factor_analysis_fusions.png -fs 14 -cs 30');
    run;
