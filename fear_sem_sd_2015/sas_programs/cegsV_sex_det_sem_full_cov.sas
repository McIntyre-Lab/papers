...
/* SEM with Full covariance */
    options ps = 70 ls=80;
    proc printto LOG='!MCLAB/cegs_sem_sd_paper/analysis_output/sem/cegsV/logs/full_cov_estimates.log' PRINT='!MCLAB/cegs_sem_sd_paper/analysis_output/sem/cegsV/full_cov_model.lst' NEW;
    run;
    ...
    proc export data=combined outfile='!MCLAB/cegs_sem_sd_paper/analysis_output/sem/cegsV/full_cov_estimates.csv' dbms=csv replace;
        putnames=yes;
        run;
