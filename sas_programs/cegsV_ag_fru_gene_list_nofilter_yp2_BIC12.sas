/*******************************************************************************
* Filename: cegsV_ag_fru_gene_list_nofilter_yp2_BIC12.sas
*
...
/* Merge Flags and add gene symbol */
    ...
    data SEM.cegsV_ag_yp2_flag_ds_fru_BIC12;
...
/* Export dataset */
    proc export data=SEM.cegsV_ag_yp2_flag_ds_fru 
        outfile='!MCLAB/cegs_sem_sd_paper/analysis_output/adding_genes/cegsV_ag_yp2_flag_ds_fru_BIC12.csv'
        dbms=csv replace;
        putnames=yes;
        run;
