/*******************************************************************************
* Filename: cegs_ag_compare_genecov_no_dsx.sas
*
...
/* Pull out added genes and compare */
    ...
    * models.
    ...
    data nodsxExpanded;
        set SEM.cegsV_ag_w_flags_bic12_no_dsx;
        rename flag_expanded = flag_expanded_dcov;
        keep primary_fbgn symbol flag_expanded;
        run;
    ...
    proc sort data=nodsxExpanded;
        by primary_fbgn;
        run;

    data geneMerge;
        merge genecovExpanded (in=in1) nodsxExpanded (in=in2);
        by primary_fbgn;
        run;

    proc freq data=geneMerge;
        tables flag_expanded_gcov*flag_expanded_dcov;
        run;

/* Clean up */
    proc datasets nolist;
        delete genecovExpanded;
        delete nodsxExpanded;
        delete geneMerge;
        run; quit;
