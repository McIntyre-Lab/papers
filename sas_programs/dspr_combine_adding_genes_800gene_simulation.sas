...
proc printto log="!HOME/tmp/dspr_adding_genes_simulation/&numgenes._gene_sim/combine.log" new; run;
%combine_bic();
...
ods graphics on;
ods pdf file="!MCLAB/cegs_sem_sd_paper/analysis_output/simulation/dspr_adding_genes_simulation_&numgenes._gene_sim_bic_dist.pdf";
