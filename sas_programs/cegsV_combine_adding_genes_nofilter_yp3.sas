...
proc printto log='/home/jfear/tmp/cegv_yp3.log' new; run;
...
data SEM.cegsV_ag_yp3_stack_bic;
    set combined;
    run;

proc transpose data=SEM.cegsV_ag_yp3_stack_bic out=flip;
    by gene;
    var BIC;
    id model;
    run;

data SEM.cegsV_ag_yp3_sbs_bic;
