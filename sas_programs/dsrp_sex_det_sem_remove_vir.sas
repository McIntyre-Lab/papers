...
/* BASELINE Gene Covaraince */
    options ps = 70 ls=80;
    proc printto LOG='!MCLAB/cegs_sem_sd_paper/analysis_output/sem/logs/remove_vir.log' PRINT='!MCLAB/cegs_sem_sd_paper/analysis_output/sem/remove_vir.lst' NEW;
    run;
    ...
    * print log and output back to listings;
    ...
    proc export data=combined outfile='!MCLAB/cegs_sem_sd_paper/analysis_output/sem/remove_vir.csv' dbms=csv replace;
    putnames=yes;
    run;
