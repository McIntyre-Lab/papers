...
/* SEM Gene Covariance */
    options ps = 70 ls=80;
    proc printto LOG='!MCLAB/cegs_sem_sd_paper/analysis_output/sem/logs/gene_cov_estimates.log' PRINT='!MCLAB/cegs_sem_sd_paper/analysis_output/sem/gene_cov_model.lst' NEW;
    run;
    ...
    proc export data=combined outfile='!MCLAB/cegs_sem_sd_paper/analysis_output/sem/dspr_gene_cov_estimates.csv' dbms=csv replace;
    putnames=yes;
    run;

    proc export data=resid outfile='!MCLAB/cegs_sem_sd_paper/analysis_output/sem/dspr_gene_cov_residuals.csv' dbms=csv replace;
    putnames=yes;
    run;
