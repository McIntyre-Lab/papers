...
/* SEM Gene Covariance */
    options ps = 70 ls=80;
    proc printto LOG='!MCLAB/cegs_sem_sd_paper/analysis_output/sem/logs/genecov_isoform_estimates.log' PRINT='!MCLAB/cegs_sem_sd_paper/analysis_output/sem/genecov_isoform_model.lst' NEW;
    run;
    ...
    proc export data=combined outfile='!MCLAB/cegs_sem_sd_paper/analysis_output/sem/genecov_isoform_estimates.csv' dbms=csv replace;
    putnames=yes;
    run;
