...
/* Add Spf45 link to only fru, suggested by residuals */
    options ps = 70 ls=80;
    proc printto LOG='!MCLAB/cegs_sem_sd_paper/analysis_output/sem/logs/move_spf45_to_tra2a_only.log' PRINT='!MCLAB/cegs_sem_sd_paper/analysis_output/sem/move_spf45_to_tra2a_only.lst' NEW;
    run;
    ...
    * print log and output back to listings;
    ...
    proc export data=combined outfile='!MCLAB/cegs_sem_sd_paper/analysis_output/sem/move_spf45_to_tra2a_only.csv' dbms=csv replace;
    putnames=yes;
    run;
