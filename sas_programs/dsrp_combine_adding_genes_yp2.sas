...
*libname addgen '!MCLAB/cegs_sem_sd_paper/adding_genes/yp2/sas_data';
libname addgen '/home/jfear/tmp/yp2/sas_data';
...
proc printto log='/home/jfear/tmp/yp2.log' new;
run;
...
data SEM.dsrp_adding_genes_yp2_stack_bic;
    set combined;
    run;
...
data SEM.dsrp_adding_genes_yp2_sbs_bic;
