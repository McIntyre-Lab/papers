...
proc printto log='/home/jfear/tmp/yp2.log' new; run;
...
data SEM.dsrp_ag_yp2_fullcov_stack_bic;
    set combined;
    run;
...
data SEM.dsrp_ag_yp2_fullcov_sbs_bic;
    ...
    Model_31 Model_32 Model_33 Model_34 ;
    set flip;
    drop _name_;
    run;
