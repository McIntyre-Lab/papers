/*******************************************************************************
* Filename: cegsV_export_adding_genes_nofilter_yp2.sas
*
...
/* Merge to Path List */
    ...
    data merged;
        ...
        merge SEM.cegsV_ag_yp2_stack_bic (in=in1) SEM.cegsV_ag_model_design_file (in=in2);
        by model;
        run;
...
/* Sort and export */
    ...
    proc export data=merged2 
            outfile='!MCLAB/cegs_sem_sd_paper/analysis_output/adding_genes/cegsV_ag_yp2_BIC_w_model_path.csv'
            dbms=csv replace;
        putnames=yes;
        run;
