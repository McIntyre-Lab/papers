/*******************************************************************************
* Filename:
* cegsV_num_models_per_gene_better_than_baseline_nofilter_yp2_BIC12_no_dsx.sas
*
...
proc export data=freq 
    outfile='!MCLAB/cegs_sem_sd_paper/analysis_output/adding_genes/cegsV_ag_yp2_num_models_per_gene_better_than_baseline_BIC12_no_dsx.csv'
    dbms=csv replace;
    putnames=yes;
    run;
