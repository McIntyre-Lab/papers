/*******************************************************************************
* Filename: cegsV_identify_best_model_adding_genes_nofilter_y2_BIC12_w_msl2.sas
*
...
/* How many models*gene imporved fit */
    ...
    proc freq data=models;
        table flag_expanded;
        run; * 13,339 models better than baseline -- 347,830 worse than baseline;
