/*******************************************************************************
* Filename: cegsV_dist_models_better_than_baseline_nofilter_yp2_BIC12.sas
*
...
/* Export dataset */
    proc export data=freqdist_w_path2 
        outfile='!MCLAB/cegs_sem_sd_paper/analysis_output/adding_genes/cegsV_ag_yp2_freq_a_model_was_better_BIC12.csv' 
        dbms=csv replace;
        putnames=yes;
        run;
