...
/* Move vir To Tra2 Model */
    options ps = 70 ls=80;
    proc printto LOG='!MCLAB/cegs_sem_sd_paper/analysis_output/sem/logs/move_vir_to_tra2_estimates.log' PRINT='!MCLAB/cegs_sem_sd_paper/analysis_output/sem/move_vir_to_tra2_estimates.lst' NEW;
    run;
    ...
    * print log and output back to listings;
    ...
    proc export data=combined outfile='!MCLAB/cegs_sem_sd_paper/analysis_output/sem/move_vir_to_tra2_estimates.csv' dbms=csv replace;
    putnames=yes;
    run;
