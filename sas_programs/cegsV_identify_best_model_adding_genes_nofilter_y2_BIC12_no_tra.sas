/*******************************************************************************
* Filename: cegsV_identify_best_model_adding_genes_nofilter_y2_BIC12_no_tra.sas
*
...
/* Get the baseline value */
    data _null_;
        set SEM.cegsV_ag_yp2_stack_bic_no_tra ;
...
/* How many models*gene imporved fit */
    ...
    proc freq data=models;
        table flag_expanded;
        run; * 10,731 models better than baseline -- 279,999 worse than baseline;
