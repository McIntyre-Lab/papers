...
*libname addgen '!MCLAB/cegs_sem_sd_paper/adding_genes/cegsV_yp2/sas_data';
libname addgen '/home/jfear/tmp/cegsV_yp2/sas_data';
...
%iterdataset(dataset=SEM.cegsV_filter_gene_list, function=%nrstr(%combine_bic(&symbol)));
...
data SEM.cegsV_adding_genes_yp2_stack_bic;
    set combined;
    run;

proc transpose data=SEM.cegsV_adding_genes_yp2_stack_bic out=flip;
    by gene;
    var BIC;
    id model;
    run;

data SEM.cegsV_adding_genes_yp2_sbs_bic;
