/*******************************************************************************
* Filename: cegsV_num_models_per_gene_better_than_baseline_nofilter_yp2_BIC12.sas
*
...
/* Export dataset */
    proc export data=freq 
        outfile='!MCLAB/cegs_sem_sd_paper/analysis_output/adding_genes/cegsV_ag_yp2_fullcov_num_models_per_gene_better_than_baseline_BIC12.csv'
        dbms=csv replace;
        putnames=yes;
        run;
