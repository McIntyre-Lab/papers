...
def main():
    ...
    if (args.prefix == ""):
            output_file_name = "custom_{}_{}".format(input_file_name, buildPrefix(args, ignoreDictionary))
            output_rtf_file = "{}/{}.rtf".format(args.outdir, output_file_name)
    else:
            output_file_name = "custom_{}_{}".format(args.prefix, buildPrefix(args, ignoreDictionary))
            output_rtf_file = "{}/{}.rtf".format(args.outdir, output_file_name)
