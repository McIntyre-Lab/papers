...
def calc_coverage(bdict,num_mapped_reads,read_length):
    ...
    for fusion in bdict:
        ...
        if depth != 0:
            ...
            bdict[fusion]['rpkm'] = (10000000000.0 * bdict[fusion]['reads_in_region']) / float(num_mapped_reads * bdict[fusion]['region_length']) # Calculate reads per kilobase per million mapped reads RPKM from Moretzavi et al. 
