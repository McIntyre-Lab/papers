...
python /blue/mcintyre/k.bankole/github/TranD/utilities/subset_gtf.py \
	-g /blue/mcintyre/share/references/dmel_fb650/dmel650_protein_coding_ref.gtf \
	-t gene_id \
	-e $PROJ/gene_exclusion.txt \
	-o /blue/mcintyre/share/references/dmel_fb650/dmel650_protein_coding_sans_trans_spliced_gene.gtf
