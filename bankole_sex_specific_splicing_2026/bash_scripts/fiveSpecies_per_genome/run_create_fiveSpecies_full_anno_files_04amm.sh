...
IN=$PROJ/submission/supplementary/fiveSpecies_annotations
...
#    --output_file $PROJ/submission/supplementary/fiveSpecies_${y}_full_annotation.csv \
#    --mismatch $PROJ/submission/supplementary/fiveSpecies_${y}_full_geneID_mismatch.csv
...
python $PROJ/scripts/create_fiveSpecies_full_anno_nonMel_files_03amm.py \
    --jxnhash_fbtr_file $IN/fiveSpecies_2_${y}_anno_files/${x}_2_${y}_ujc_xscript_link.csv \
    --genome ${y} \
    --erp_file $IN/fiveSpecies_2_${y}_anno_files/fiveSpecies_2_${y}_ujc_er_vs_fiveSpecies_2_${y}_ujc_infoERP.csv \
    --esp_file $IN/fiveSpecies_2_${y}_anno_files/fiveSpecies_2_${y}_ujc_es_vs_fiveSpecies_2_${y}_ujc_infoESP.csv \
    --flag_file $IN/fiveSpecies_2_${y}_anno_files/flag_fiveSpecies_2_${y}_ujc_w_IR_flag.csv \
    --dmel6_file $PROJ/submission/supplementary/fiveSpecies_dmel6_full_annotation.csv \
