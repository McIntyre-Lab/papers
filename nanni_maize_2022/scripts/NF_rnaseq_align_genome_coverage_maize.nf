...
// (1) align merged reads - SE alignment to reference genome
// (2) align unmerged reads - PE alignemnt to reference genome
// (3) combine SE and PE reference genome alignments with samtools merge
