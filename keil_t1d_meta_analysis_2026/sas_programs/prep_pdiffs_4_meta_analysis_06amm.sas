...
*** NOTE:  this version (06amm) is all genes, not just t1d
...
data ES_SV_&cell._4_ma ;
retain geneID featureID group sex cellType effect_size variance ;
set  ES_SV_&cell. ;
cellType = "&cell.";
run ;

proc export data = ES_SV_&cell._4_ma
outfile = "!MCLAB/t1d_case_control_cellType/quantify_t1d_pacbio_transcripts/ES_SV_&cell._pdiff_4_ma.csv"
dbms = csv replace ;
run;
...
data both ;
set  ES_SV_CD4_4_ma ES_SV_CD8_4_ma ;
run ;
...
proc export data = ES_SV_CD4_CD8 
outfile = "!MCLAB/t1d_case_control_cellType/quantify_t1d_pacbio_transcripts/ES_SV_CD4_CD8_pdiff_4_ma.csv"
dbms = csv replace ;
run;

proc freq data = ES_SV_CD4_CD8 ;
by exonID ;
...
data added ;
merge contrast (in=in1) ES_SV_CD4_CD8 (in=in2) ;
by exonID ;
run ;

data ES_SV_CD4_CD8_exon ;
set added ;
where flag_run = 1 ;
drop flag_run ;
run;

proc export data = ES_SV_CD4_CD8_exon 
outfile = "!MCLAB/t1d_case_control_cellType/quantify_t1d_pacbio_transcripts/ES_SV_CD4_CD8_pdiff_exon.csv"
dbms = csv replace ;
run;
...
/* combine cell types into single dataset for meta-analysis with cellType as moderator */
data three ;
set ES_SV_CD19_4_ma ES_SV_CD4_4_ma ES_SV_CD8_4_ma ;
run ;
...
proc export data = ES_SV_CD4_CD8_CD19 
outfile = "!MCLAB/t1d_case_control_cellType/quantify_t1d_pacbio_transcripts/meta_analysis_DE_pdiffs/ES_SV_CD4_CD8_CD19_pdiff.csv"
dbms = csv replace ;
run;

proc freq data = ES_SV_CD4_CD8_CD19 ;
by exonID ;
tables cellType_sex / out = aa_fet_cnts ;
run;
proc freq data = aa_fet_cnts ;
...
proc sort data = ES_SV_CD4_CD8_CD19 ;
by exonID ;
proc sort data = contrast ;
by exonID ;
run ;
...
data added ;
merge contrast (in=in1) ES_SV_CD4_CD8_CD19 (in=in2) ;
by exonID ;
run ;

data ES_SV_CD4_CD8_CD19_exon ;
set added ;
where flag_run = 1 ;
drop flag_run ;
run;

proc export data = ES_SV_CD4_CD8_CD19_exon 
outfile = "/nfshome/ammorse/mclab/SHARE/McIntyre_Lab/t1d_case_control_cellType/quantify_t1d_pacbio_transcripts/meta_analysis_DE_pdiffs/ES_SV_CD4_CD8_pdiff_exon.csv"
dbms = csv replace ;
run;
