...
PROC IMPORT OUT= WORK.hubs 
            DATAFILE= "/home/agerken/McLab/cegs_ase_paper/Pool_2015_gene_lists/Table7_gene_list.csv" 
            DBMS=CSV REPLACE;
     GETNAMES=YES;
     DATAROW=2; 
	guessingrows=1689;
...
PROC IMPORT OUT= WORK.european 
            DATAFILE= "/home/agerken/McLab/cegs_ase_paper/Pool_2015_gene_lists/Table4_european_gene_list.csv" 
            DBMS=CSV REPLACE;
     GETNAMES=YES;
     DATAROW=2; 
	guessingrows=3389;
...
PROC IMPORT OUT= WORK.african 
            DATAFILE= "/home/agerken/McLab/cegs_ase_paper/Pool_2015_gene_lists/Table4_african_gene_list.csv" 
            DBMS=CSV REPLACE;
     GETNAMES=YES;
     DATAROW=2; 
	guessingrows=3344;
...
proc sort data= table4_african_genes;
by gene_name;
...
merge table4_african_genes table4_european_genes table7_genes;
by gene_name;
