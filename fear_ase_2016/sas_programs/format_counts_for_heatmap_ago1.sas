...
%macro import (geno, rep);
       data &geno._&rep    ;
       %let _EFIERR_ = 0; 
       infile "McLab/cegs_ase_paper/output/counts_gene_ago1/&geno._&rep..txt" delimiter='09'x MISSOVER
...
count_1 = substr(put(col1,20.), 13,2);
count = count_1 + 0;
genotype = "&geno";
rep = "&rep";
drop col1;
...
outfile = "McLab/cegs_ase_paper/output/mated_ago1_counts_for_heatmap.csv"
dbms=csv replace;
putnames=yes;
run;

proc export data=virgin_mean2
outfile = "McLab/cegs_ase_paper/output/virgin_ago1_counts_for_heatmap.csv"
dbms=csv replace;
putnames=yes;
run;
...
outfile = "McLab/cegs_ase_paper/output/mated_ago1_counts_scaled.csv"
dbms=csv replace;
putnames=yes;
run;

proc export data=virgin_scaled
outfile = "McLab/cegs_ase_paper/output/virgin_ago1_counts_scaled.csv"
dbms=csv replace;
putnames=yes;
run;
