...
groups <- list("ALL")
#groups <- list("TCA", "UGT", "NI", "NInoN2", "COMBO")
...
# Get input data
        data = read.csv(paste("~/mclab/SHARE/McIntyre_Lab/shaver_metaanalysis_2022/nmr/meta_plotting/zihao_other_plots/effect_size_matrix_hmp_", type, "_", group, ".csv", sep=""))
...
#        colors = c(#1f77b4', '#aec7e8', '#ff7f0e', '#ffbb78', '#2ca02c', '#98df8a', '#d62728', '#ff9896', '#9467bd', '#c5b0d5', '#8c564b', '#c49c94', '#e377c2', '#f7b6d2', '#7f7f7f', '#c7c7c7', '#bcbd22', '#dbdb8d', '#17becf', '#9edae5', 'black')
...
##        pdf(paste('/nfshome/ammorse/mclab/SHARE/McIntyre_Lab/shaver_metaanalysis_2022/nmr/meta_plotting/MA_heatmap_', type, "_", group, '.pdf', sep = ""))
        svg(paste('/nfshome/ammorse/mclab/SHARE/McIntyre_Lab/shaver_metaanalysis_2022/nmr/meta_plotting/MA_heatmap_', type, "_", group, '.svg', sep = ""))
