...
#for group in ['TCA', 'UGT', 'NI', 'NInoN2', 'COMBO']:
for group in ['ALL']:
    ...
    for type in ['cdcl3', 'd2o']:
        ...
        ## by pathway
        combined = pd.read_csv("~/mclab/SHARE/McIntyre_Lab/shaver_metaanalysis_2022/nmr/meta_analysis/MA_fixedEffect_pathway_NMR_" + type + "_rank_" + group + "_summary.tsv", sep='\t')
        ...
        df_mut = combined
        mutpath = "~/mclab/SHARE/McIntyre_Lab/shaver_metaanalysis_2022/nmr//meta_analysis/"
        ## by mutant
        for mut in muts:
            f = mutpath + "MA_fixedEffect_NMR_" + type + "_rank_" + mut + "_" + type + "_SMD_summary.tsv"
            dat = pd.read_csv(f)
...
############ extract a effect size matrix for heatmap in R
        ...
        es_matrix.to_csv("~/mclab/SHARE/McIntyre_Lab/shaver_metaanalysis_2022/nmr/meta_plotting/effect_size_matrix_hmp_" + type + "_" + group + ".csv")
        print(len(es_matrix))
...
#        colors = ['red', 'blue', 'green', 'orange', 'black', 'purple']
        ...
        fig.savefig('/nfshome/ammorse/mclab/SHARE/McIntyre_Lab/shaver_metaanalysis_2022/nmr/meta_plotting/effect_all_model_same_direct_' + type + "_" + group + '.pdf')
        plt.close(fig)
...
###
        ...
        fig.savefig("/nfshome/ammorse/mclab/SHARE/McIntyre_Lab/shaver_metaanalysis_2022/nmr/meta_plotting/upset_sigCounts_not_all_same_direct_" + type + "_" + group + ".pdf", format='pdf')
        fig.savefig("/nfshome/ammorse/mclab/SHARE/McIntyre_Lab/shaver_metaanalysis_2022/nmr/meta_plotting/upset_sigCounts_not_all_same_direct_" + type + "_" + group + ".svg", format='svg')
        plt.close(fig)
