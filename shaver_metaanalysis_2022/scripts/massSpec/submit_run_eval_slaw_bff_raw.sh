...
## run QC raw 
#source ${PROJ}/scripts/massSpec/run_evaluate_slaw_bff_raw.sh 2>&1 > $LOG/rp_neg_raw_qc.log
...
## run QC raw noBlanks
#source ${PROJ}/scripts/massSpec/run_evaluate_slaw_bff_raw.sh 2>&1 > $LOG/rp_pos_raw_qc.log
...
## run QC raw noBlanks
#source ${PROJ}/scripts/massSpec/run_evaluate_slaw_bff_raw.sh 2>&1 > $LOG/hilic_pos_raw_qc.log
...
## run QC raw noBlanks
source ${PROJ}/scripts/massSpec/run_evaluate_slaw_bff_raw.sh 2>&1 > $LOG/hilic_neg_raw_qc.log
