...
QC=$PROJ/SLAW_UGA_Output/qc_raw_${VAR}
    mkdir -p $QC
...
python $SCRIPTS/coefficient_variation_flags.py \
    ...
    --group ${i} \
    --CVcutoff 0.1 \
    --figure $QC/CV_figure_${i}_${VAR}_PH_raw.pdf \
    --flag $QC/CV_flags_${i}_${VAR}_PH_raw.tsv
    ...
    python $SCRIPTS/standardized_euclidean_distance.py \
        ...
        --ID UniqueID \
        --group ${i} \
        --figure $QC/SED_figure_${i}_${VAR}_PH_raw.pdf \
        --SEDtoMean $QC/SEDtoMean_${i}_${VAR}_PH_raw.tsv \
...
## PCA
    ...
    python $SCRIPTS/principal_component_analysis.py \
        ...
        --ID UniqueID \
        --group ${i} \
        --load_out $QC/PCA_loading_${i}_${VAR}_PH_raw.tsv \
        --score_out $QC/PCA_scores_${i}_${VAR}_PH_raw.tsv \
        --summary_out $QC/PCA_summary_${i}_${VAR}_PH_raw.tsv \
        --figure $QC/PCA_figure_${i}_${VAR}_PH_raw.pdf
  ...
  ## distribution samples 
    ...
    python $SCRIPTS/distribution_samples.py \
        ...
        --ID UniqueID \
        --group sampleType \
        --figure $QC/distSamples_${i}_${VAR}_PH_raw.pdf
  ...
  ## distribution features
    ...
    python $SCRIPTS/distribution_features.py \
        ...
        --ID UniqueID \
        --group sampleType \
        --figure $QC/distFeatures_${i}_${VAR}_PH_raw.pdf
