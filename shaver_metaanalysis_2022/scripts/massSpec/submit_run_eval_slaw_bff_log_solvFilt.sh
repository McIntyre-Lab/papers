...
## run QC log 
source ${PROJ}/scripts/massSpec/run_evaluate_slaw_bff_log_solvFilt.sh 2>&1 > $LOG/rp_neg_log_solvFilt_qc.log
...
## run QC log
source ${PROJ}/scripts/massSpec/run_evaluate_slaw_bff_log_solvFilt.sh 2>&1 > $LOG/rp_pos_log_solvFilt_qc.log
...
## run QC log
source ${PROJ}/scripts/massSpec/run_evaluate_slaw_bff_log_solvFilt.sh 2>&1 > $LOG/hilic_pos_log_solvFilt_qc.log
...
## run QC log 
source ${PROJ}/scripts/massSpec/run_evaluate_slaw_bff_log_solvFilt.sh 2>&1 > $LOG/hilic_neg_log_solvFilt_qc.log
