...
QC=$PROJ/SLAW_UGA_Output/qc_rank_${VAR}
    mkdir -p $QC
...
python $SCRIPTS/coefficient_variation_flags.py \
    ...
    --group ${i} \
    --CVcutoff 0.1 \
    --figure $QC/CV_figure_${i}_${VAR}_PH_rank.pdf \
    --flag $QC/CV_flags_${i}_${VAR}_PH_rank.tsv
    ...
    python $SCRIPTS/standardized_euclidean_distance.py \
        ...
        --ID UniqueID \
        --group ${i} \
        --figure $QC/SED_figure_${i}_${VAR}_PH_rank.pdf \
        --SEDtoMean $QC/SEDtoMean_${i}_${VAR}_PH_rank.tsv \
...
## PCA
    ...
    python $SCRIPTS/principal_component_analysis.py \
        ...
        --ID UniqueID \
        --group ${i} \
        --load_out $QC/PCA_loading_${i}_${VAR}_PH_rank.tsv \
        --score_out $QC/PCA_scores_${i}_${VAR}_PH_rank.tsv \
        --summary_out $QC/PCA_summary_${i}_${VAR}_PH_rank.tsv \
        --figure $QC/PCA_figure_${i}_${VAR}_PH_rank.pdf
  ...
  ## distribution samples 
    ...
    python $SCRIPTS/distribution_samples.py \
        ...
        --ID UniqueID \
        --group sampleType \
        --figure $QC/distSamples_${i}_${VAR}_PH_rank.pdf
  ...
  ## distribution features
    ...
    python $SCRIPTS/distribution_features.py \
        ...
        --ID UniqueID \
        --group sampleType \
        --figure $QC/distFeatures_${i}_${VAR}_PH_rank.pdf
