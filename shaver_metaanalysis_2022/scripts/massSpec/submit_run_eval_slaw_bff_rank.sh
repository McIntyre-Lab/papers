...
## run QC rank 
#source ${PROJ}/scripts/massSpec/run_evaluate_slaw_bff_rank.sh 2>&1 > $LOG/rp_neg_rank_qc.log
...
## run QC rank
#source ${PROJ}/scripts/massSpec/run_evaluate_slaw_bff_rank.sh 2>&1 > $LOG/rp_pos_rank_qc.log
...
## run QC log
#source ${PROJ}/scripts/massSpec/run_evaluate_slaw_bff_rank.sh 2>&1 > $LOG/hilic_pos_rank_qc.log
...
## run QC log 
source ${PROJ}/scripts/massSpec/run_evaluate_slaw_bff_rank.sh 2>&1 > $LOG/hilic_neg_rank_qc.log
