...
# Get input data
        data = read.csv(paste("~/mclab/SHARE/McIntyre_Lab/shaver_metaanalysis_2022/massSpec/meta_plotting/effect_size_matrix_hmp_", type, "_", group, ".csv", sep=""))
...
#        pdf(paste('/nfshome/ammorse/mclab/SHARE/McIntyre_Lab/shaver_metaanalysis_2022/massSpec/meta_plotting/MA_heatmap_', type, "_", group, '.pdf', sep = ""))
        svg(paste('/nfshome/ammorse/mclab/SHARE/McIntyre_Lab/shaver_metaanalysis_2022/massSpec/meta_plotting/MA_heatmap_', type, "_", group, '.svg', sep = ""))
