...
outfile = "/nfshome/ammorse/mclab/SHARE/McIntyre_Lab/CID/sweet16/SLAW_UGA_Output/comparing_models/&dataout._plot.csv"
dbms = csv replace ;
run ;
%mend ;
...
outfile = "/nfshome/ammorse/mclab/SHARE/McIntyre_Lab/CID/sweet16/SLAW_UGA_Output/comparing_models/upset_plot_design_file_&path._sig.csv"
dbms = csv replace ;
run ;

proc export data = dsgn_&path._ge_pd1074
outfile = "/nfshome/ammorse/mclab/SHARE/McIntyre_Lab/CID/sweet16/SLAW_UGA_Output/comparing_models/upset_plot_design_file_&path._ge_pd1074.csv"
dbms = csv replace ;
run ;
