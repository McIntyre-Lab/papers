...
set sig_&tech. ;
where flag_keep = 1 ;
keep featureID effect_: ;
run ;

proc export data = heatmap_&tech.
outfile = "/nfshome/ammorse/mclab/SHARE/McIntyre_Lab/CID/sweet16/SLAW_UGA_Output/meta_analysis_&tech./MA_byStrain_sig_4_heatmap.tsv"
dbms = tab replace ;
run;
...
outfile = "/nfshome/ammorse/mclab/SHARE/McIntyre_Lab/CID/sweet16/SLAW_UGA_Output/meta_analysis_&tech./MA_byStrain_sig_4_upset_&tech..csv"
dbms = csv replace ;
run;
...
outfile = "/nfshome/ammorse/mclab/SHARE/McIntyre_Lab/CID/sweet16/SLAW_UGA_Output/meta_analysis_&tech./upset_dsgn_&tech..csv"
dbms = csv replace ;
run;
...
proc export data = heatmap_&tech.
outfile = "/nfshome/ammorse/mclab/SHARE/McIntyre_Lab/CID/sweet16/nmr/meta_analysis/MA_byStrain_sig_4_heatmap_&tech..tsv"
dbms = tab replace ;
run;
...
proc export data = upset_&tech
outfile = "/nfshome/ammorse/mclab/SHARE/McIntyre_Lab/CID/sweet16/nmr/meta_analysis/MA_byStrain_sig_4_upset_&tech..csv"
dbms = csv replace ;
run;
...
proc export data = upset_dsgn_&tech.
outfile = "/nfshome/ammorse/mclab/SHARE/McIntyre_Lab/CID/sweet16/nmr/meta_analysis/upset_dsgn_&tech..csv"
dbms = csv replace ;
run;
...
/* hierarchical clustering needs design */
proc contents data = heatmap_rp_neg out = varsing noprint;
run;
...
outfile = "/nfshome/ammorse/mclab/SHARE/McIntyre_Lab/CID/sweet16/nmr/meta_analysis/dsgn_effectSizes_4_heatmap.tsv"
dbms = tab replace ;
run;
...
proc export data = dsgn 
outfile = "/nfshome/ammorse/mclab/SHARE/McIntyre_Lab/CID/sweet16/SLAW_UGA_Output/meta_analysis_&tech./dsgn_effectSizes_4_heatmap.tsv"
dbms = tab replace ;
run;
%mend ;
