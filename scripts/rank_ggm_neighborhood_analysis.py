...
def getNeighbors(nxGraph, target, geneList, splicingFactors):
    ...
    total = numPrimary + numSecondary
    numSex = numPrimSex + numSecSex 
    ...
    return([target, flag_sex, flag_splice, numPrimary, numPrimSex, numSecondary, numSecSex, total, numSex])
...
if __name__ == "__main__":
    ...
    lname = "/home/jfear/mclab/cegs_sem_sd_paper/analysis_output/rank_ggm/dsrp_neighborhood_analysis.log"
    dotname = "/home/jfear/mclab/cegs_sem_sd_paper/analysis_output/rank_ggm/dsrp_ggm_isoforms_FDR2.dot"
    oname = "/home/jfear/mclab/cegs_sem_sd_paper/analysis_output/rank_ggm/dsrp_neighborhood_analysis.csv"
    ...
    with open(oname, 'w') as OUT:
        myHeader = ["FG", "FG_sex", "FG_splice", "num_primary", "num_primary_sex", "num_secondary", "num_secondary_sex", "total_neighbor", "total_neighbor_sex"]
