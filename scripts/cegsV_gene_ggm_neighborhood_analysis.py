...
if __name__ == "__main__":
    ...
    lname = "/scratch/lfs/mcintyre/sem_gof/neighborhood_analysis/cegsV_gene_level_neighborhood_analysis.log"
    dotname = "/scratch/lfs/mcintyre/sem_gof/neighborhood_analysis/cegsV_ggm_gene_FDR2.dot"
    oname = "/scratch/lfs/mcintyre/sem_gof/neighborhood_analysis/cegsV_gene_level_neighborhood_analysis.csv"
