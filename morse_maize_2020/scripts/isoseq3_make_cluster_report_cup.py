...
def make_cluster_report_from_polished_bam(polished_bam,output_prefix):
    f = pysam.Samfile(polished_bam, check_sq=False)
    h = open(output_prefix+'.cluster_report.csv', 'w')
...
if __name__ == "__main__":
    ...
    parser.add_argument("output_prefix", help="Output prefix for cluster_report.csv")
    ...
    make_cluster_report_from_polished_bam(args.polished_bam,args.output_prefix)
