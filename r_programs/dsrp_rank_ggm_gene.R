...
network.make.dot(paste(mclab,"/cegs_sem_sd_paper/analysis_output/rank_ggm/dsrp_ggm_isoforms_FDR2.dot",sep=""),mydata.net, node.labels, show.edge.labels=TRUE, main="Isoform GGM")
