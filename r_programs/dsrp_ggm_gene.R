...
mydata <- read.csv('/home/jfear/tmp/dsrp_by_gene_sbs.txt',header=TRUE)
...
network.make.dot(paste(mclab,"/cegs_sem_sd_paper/analysis_output/ggm/dsrp_ggm_gene_FDR2.dot",sep=""),mydata.net, node.labels, show.edge.labels=TRUE, main="DSPR Gene GGM")
