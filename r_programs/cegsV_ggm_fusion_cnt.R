...
mydata <- read.csv('/home/jfear/tmp/cegsv_by_fusion_cnt_sbs.txt',header=TRUE)
...
network.make.dot(paste(mclab,"/cegs_sem_sd_paper/analysis_output/ggm/cegsV_ggm_fusions_cnt_FDR2.dot",sep=""),mydata.net, node.labels, show.edge.labels=TRUE, main="Exonic Region Level GGN")
