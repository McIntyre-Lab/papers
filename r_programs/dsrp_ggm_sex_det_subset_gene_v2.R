...
# Only keep edges with a local fdr 0.2 (cutoff.ggm = 1-0.2)
    ...
    network.make.dot(paste(mclab,"/cegs_sem_sd_paper/analysis_output/ggm/dsrp_ggm_sex_det_gene_FDR2.dot",sep=""),mydata.net, node.labels, show.edge.labels=TRUE, main="Sex Determination Subset Gene GGM")
    system("dot -T png -o $MCLAB/cegs_sem_sd_paper/analysis_output/ggm/dsrp_ggm_sex_det_gene_FDR2.png $MCLAB/cegs_sem_sd_paper/analysis_output/ggm/dsrp_ggm_sex_det_gene_FDR2.dot")
...
# Keep top 20 edges
    ...
    # Plot the Network
    node.labels <- colnames(mydata)
    network.make.dot(paste(mclab,"/cegs_sem_sd_paper/analysis_output/ggm/dsrp_ggm_sex_det_gene_TOP20.dot",sep=""),mydata.net, node.labels, show.edge.labels=TRUE, main="Sex Determination Subset Gene GGM")
    system("dot -T png -o $MCLAB/cegs_sem_sd_paper/analysis_output/ggm/dsrp_ggm_sex_det_gene_TOP20.png $MCLAB/cegs_sem_sd_paper/analysis_output/ggm/dsrp_ggm_sex_det_gene_TOP20.dot")
