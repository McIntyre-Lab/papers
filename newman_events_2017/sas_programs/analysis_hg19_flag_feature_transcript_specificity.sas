...
proc sort data=event.hg19_feature2xs2gene_exp_only2 nodup;
   by gene_id;
...
data feat2xs2gene;
  merge event.hg19_feature2xs2gene_exp_only2 (in=in1) xs_per_gene2 (in=in2);
  by gene_id;
  if in1 and in2;
run;
...
data event.hg19_flag_feat_specificity_exp;
...
/*
    ...
    ---------------------------------------------------------------------
                   0      225017       39.23        225017        39.23
                   1      348627       60.77        573644       100.00
   ...
   Total      425326   148318   573644
     ...
     Col Pct  |       0|       1|  Total
     ---------+--------+--------+
            0 | 225017 | 348627 | 573644
              |  39.23 |  60.77 | 100.00
              |  39.23 |  60.77 |
              | 100.00 | 100.00 |
     ---------+--------+--------+
     Total      225017   348627   573644
                 39.23    60.77   100.00
