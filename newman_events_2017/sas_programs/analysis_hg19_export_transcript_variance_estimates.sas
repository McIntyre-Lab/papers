...
proc export data=xs_all_data
     outfile="!MCLAB/event_analysis/analysis_output/hg19_aceview_all_transcripts_variance.csv"
     dbms=csv replace;
run;

proc export data=xs_filt_data
     outfile="!MCLAB/event_analysis/analysis_output/hg19_aceview_75perc_apn5_transcripts_variance.csv"
     dbms=csv replace;
run;
