...
/* Import RSEM results for the filtered hg19 Aceview transcriptome */
...
%macro importRSEM(library);
    ...
    infile
"/mnt/store/event_sandbox/rsem_output/aceview_hg19_75perc_apn5/&library..isoforms.results"
delimiter='09'x MISSOVER DSD lrecl=32767 firstobs=2 ;
       informat transcript_id $91. ;
       informat gene_id $30. ;
...
data eventloc.hg19_rsem_75perc_apn5_xscripts;
