...
/* Import exon fragment counts */

    data WORK.COUNTS_BY_FRAGMENT    ;
    %let _EFIERR_ = 0; /* set the ERROR detection macro variable */
    infile '!MCLAB/event_analysis/alignment_output/mm10_refseq_fragment_counts.csv' delimiter
...
data events.mm10_refseq_fragment_counts;
