...
data ctla4 il7r ikzf1 ikzf3 rasgrp1;
   ...
   if gene_id="RASGRP1" then output rasgrp1;
run;
...
proc export data=ikzf3
     ...
     dbms=csv replace;
run;
proc export data=rasgrp1
     outfile="!MCLAB/event_analysis/analysis_output/mean_log_tpm_by_xscript_celltype_t1d_only_RASGRP1.csv"
     dbms=csv replace;
run;
