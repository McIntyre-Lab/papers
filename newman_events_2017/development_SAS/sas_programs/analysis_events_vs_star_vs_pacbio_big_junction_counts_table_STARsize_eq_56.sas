...
data apn_star;
   set event.npc_star_junctions_est_apn_56bp;
...
proc freq data=junc_tables_star_apn noprint;
  ...
  tables junction_type*flag_in_pacbio*flag_events_NSC_apn_gt0*flag_star_NSC_apn_gt0 / out=junc_count_apn0;

  tables junction_type*flag_in_pacbio*flag_events_NSC_apn_ge5*flag_star_NSC_apn_ge5 / out=junc_count_apn5;

  tables junction_type*flag_in_pacbio*flag_events_NSC_apn_ge10*flag_star_NSC_apn_ge10 / out=junc_count_apn10;
...
proc export data=junc_count_dtct
     outfile="!MCLAB/event_Analysis/analysis_output/junctions_pacbio_vs_catalog_vs_star_detection_STARsize_56bp.csv"
     dbms=csv replace;
run;

proc export data=junc_count_apn0
     outfile="!MCLAB/event_Analysis/analysis_output/junctions_pacbio_vs_catalog_vs_star_support_apn0_STARsize_56bp.csv"
     dbms=csv replace;
run;

proc export data=junc_count_apn5
     outfile="!MCLAB/event_Analysis/analysis_output/junctions_pacbio_vs_catalog_vs_star_support_apn5_STARsize_56bp.csv"
     dbms=csv replace;
run;

proc export data=junc_count_apn10
     outfile="!MCLAB/event_Analysis/analysis_output/junctions_pacbio_vs_catalog_vs_star_support_apn10_STARsize_56bp.csv"
     dbms=csv replace;
run;
