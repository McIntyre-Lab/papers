...
data list1_2;
   ...
   keep transcript_id pacbio_id pacbio_gene_id;
   run;
...
proc sort data=list4_2;
  ...
  data list1_w_gene;
     merge xs2gene (in=in1) list1_2 (in=in2);
     by transcript_id;
     if in1 and in2;
     run;
     
  data list2_w_gene;
     merge xs2gene (in=in1) list2_2 (in=in2);
     by transcript_id;
     if in1 and in2;
     run;
     
  data list3_w_gene;
     merge xs2gene (in=in1) list3_2 (in=in2);
     by transcript_id;
     if in1 and in2;
     run;
     
  data list4_w_gene;
     merge xs2gene (in=in1) list4_2 (in=in2);
     by transcript_id;
     if in1 and in2;
     run;
