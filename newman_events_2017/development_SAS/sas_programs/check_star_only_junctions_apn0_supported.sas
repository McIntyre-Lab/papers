...
data check;
   ...
   where flag_star_NSC_apn_gt0=1 and flag_events_NSC_apn_gt0=0
...
/* Export */
proc export data=junc_fasta2export2 outfile="!MCLAB/event_analysis/analysis_output/star_junctions_to_blast_apn0.fa"
     dbms=tab replace;
     putnames=no;
run;

proc export data=junc_design outfile="!MCLAB/event_analysis/analysis_output/star_junctions_to_check_apn0.csv"
     dbms=csv replace;
run;
