...
data genes_for_plots;
   set event.t1d_case_only_kw_test_reduced;
   if flag_kw_cd4cd8_p05=1 or flag_kw_cd4cd19_p05=1 or flag_kw_cd8cd19_p05=1;
   keep gene_id;
run;
...
proc export data=export_counts outfile="!MCLAB/event_analysis/analysis_output/t1d_cases_mean_tpm_diff_mei_by_ranktest_reduced.csv"
   dbms=csv replace;
run;

*output gene list;

proc export data=genes_for_plots outfile="!MCLAB/event_analysis/analysis_output/t1d_cases_gene_list_ranktest_reduced.csv"
