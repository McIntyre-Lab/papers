...
data flag_apn;
  ...
  if NSC1 ge 2 then flag_events_NSC1_apn_ge2=1; else flag_events_NSC1_apn_ge2=0;
  if NSC2 ge 2 then flag_events_NSC2_apn_ge2=1; else flag_events_NSC2_apn_ge2=0;
...
NNC, novel donor and acceptor       51437        1.69       2803836        91.87
border junction                    247983        8.13       3051819       100.00
...
/*
 ...
 Annotated                            0           1           0        149891     4.9115
 Annotated                            0           1           1         71771     2.3517
 Annotated                            1           1           0          2275     0.0745
 Annotated                            1           1           1         66118     2.1665
 NIC/Unannotated                      0           1           0       2450648    80.3012
 NIC/Unannotated                      0           1           1          9116     0.2987
...
TOTAL, DETECTION, APN0, APN2, APN5, APN10:
pacbio
catalog
star
catalog*star
...
proc freq data=junc_tables_star_apn2;
   ...
   tables junction_type*flag_events_NSC_apn_ge10
          junction_type*flag_star_NSC_apn_ge10;cd 
run;
