...
/* Export counts for making plots to visualize the distribution of data
...
proc export data=feat_data_for_plots outfile="!MCLAB/event_analysis/analysis_output/event_analysis_features_retained_with_info_nomulti.csv" dbms=csv replace;
run;


data event.feature_data_for_plots;
