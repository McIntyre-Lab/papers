...
* Export;
proc export data=feat_data_for_plots outfile="!MCLAB/event_analysis/analysis_output/event_analysis_features_retained_with_info_gene_filtered_nomulti.csv" dbms=csv replace;
run;
