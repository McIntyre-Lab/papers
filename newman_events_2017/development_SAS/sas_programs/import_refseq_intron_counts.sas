...
/* Import fusion counts */
    ...
    data WORK.COUNTS_BY_INTRON    ;
    %let _EFIERR_ = 0; /* set the ERROR detection macro variable */
    infile '!MCLAB/event_analysis/alignment_output/mm10_refseq_intron_counts.csv' delimiter
= ',' MISSOVER DSD lrecl=32767 firstobs=2 ;
       informat sample_id $4. ;
       informat intron_id $63. ;
...
data event.mm10_refseq_intron_counts;
  set counts_by_intron;
run;
