...
proc import datafile="!MCLAB/event_analysis/alignment_output/aln_mm10_star_10genes_nic_simulation/&sample.SJ.out.tab"
...
%macro importCC(sample);
    ...
    infile "!MCLAB/event_analysis/alignment_output/coverage_counts_splicing_10genes_nic/cvrg_cnts_&sample..csv" delimiter
...
/* For catalog junctions, I really only want to keep the junctions from the 10 genes selected, but I also want
...
data event.star_junctions_10genes_nic;
   set star_juncs;
run;

data event.catalog_junctions_10genes_nic;
