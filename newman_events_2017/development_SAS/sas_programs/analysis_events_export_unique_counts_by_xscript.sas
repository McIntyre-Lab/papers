...
proc export data=event.uniq_feature_counts_by_xscript
     outfile="!MCLAB/event_analysis/analysis_output/event_analysis_uniq_features_by_xscript.csv" dbms=csv replace;
run;


proc export data=event.uniq_feature_counts_by_gene
     outfile="!MCLAB/event_analysis/analysis_output/event_analysis_uniq_features_by_gene.csv" dbms=csv replace;
run;
