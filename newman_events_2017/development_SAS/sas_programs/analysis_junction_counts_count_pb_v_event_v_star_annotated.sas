...
%include "!MCLAB/event_analysis/sas_programs/analysis_junc_counts_star_vs_pacbio_annotated.sas";


/***** Annotated : EA vs Pacbio *****/
%include "!MCLAB/event_analysis/sas_programs/analysis_junc_counts_events_vs_pacbio_annotated.sas";
...
*****/
%include "!MCLAB/event_analysis/sas_programs/analysis_junc_counts_events_vs_star_annotated.sas";
