...
/* Import splicing counts  */
    ...
    %let _EFIERR_ = 0; 
    infile '/mnt/store/event_sandbox/polyester_simulated_data/10genes_nic/counts_by_splicing_10genes.csv' 
      delimiter
...
/* Fusion counts */
    ...
    %let _EFIERR_ = 0; 
    infile '/mnt/store/event_sandbox/polyester_simulated_data/10genes_nic/counts_by_fusion_10genes.csv' delimiter
= ',' MISSOVER DSD lrecl=32767 firstobs=2 ;
       informat sample_id $10. ;
...
/* Fragment counts */
    ...
    %let _EFIERR_ = 0;
    infile '/mnt/store/event_sandbox/polyester_simulated_data/10genes_nic/counts_by_fragment_10genes.csv' delimiter
= ',' MISSOVER DSD lrecl=32767 firstobs=2 ;
       informat sample_id $10. ;
       informat fusion_id $13. ;
       informat mapped_reads best32. ;
...
data event.mm10_refseq_splicing_counts_10gn;
 set SPLICING_COUNTS;
 keep sample_id event_id region_depth apn;
run;

data event.mm10_refseq_fusion_counts_10gn;
  set counts_by_fusion;
  keep sample_id fusion_id apn;
run;

data event.mm10_refseq_fragment_counts_10gn;
...
data fus_counts;
   set event.mm10_refseq_fusion_counts_10gn;
...
/* Make permenant */
data event.feature2xs2gene_exp_nomult_10gn;
...
* Junctions;
data flag_splicing;
  set event.mm10_refseq_splicing_counts_10gn;
...
* Fragments;
data flag_fragment;
  set event.mm10_refseq_fragment_counts_10gn;
...
data feat2xs;
  set event.feature2xs2gene_exp_nomult_10gn;
...
data event.bin_xs_by_dtct_apn&apn._10gn;
   set bin_xs;
run;
