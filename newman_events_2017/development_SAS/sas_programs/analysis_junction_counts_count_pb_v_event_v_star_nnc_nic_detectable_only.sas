...
For EA junctions I am only considering those junctions that have at least one read in total mapping to them
(i.e. APN>0 in either sample)
...
/***** NIC : STAR vs Pacbio *****/
%include "!MCLAB/event_analysis/sas_programs/analysis_junc_counts_star_vs_pacbio_NIC_detectable_only.sas";

/***** NIC : EA vs Pacbio *****/
%include "!MCLAB/event_analysis/sas_programs/analysis_junc_counts_events_vs_pacbio_NIC_detectable_only.sas";

/***** NNC : STAR vs Pacbio *****/
%include "!MCLAB/event_analysis/sas_programs/analysis_junc_counts_star_vs_pacbio_NNC_detectable_only.sas";
...
*****/
%include "!MCLAB/event_analysis/sas_programs/analysis_junc_counts_events_vs_star_NIC_detectable_only.sas";
