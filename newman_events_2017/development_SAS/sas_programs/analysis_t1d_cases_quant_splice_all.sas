...
data event.t1d_quant_splice_anova_all;
   set anova;
run;

data event.t1d_quant_splice_resid_all;
   set resid;
run;

data event.t1d_quant_splice_lsmeans_all;
   set lsmeans;
run;

data event.t1d_quant_splice_flag_p05_all;
   set flag_sig_int;
run;
