...
data ir_collapse_flag_60gn;
  merge ir_collapse2 (in=in1) sim_list (in=in2);
  by transcript_id2;
...
CORRECT			180		transcripts that were selected for simulation
...
RELATED_OTHER	12		Non-RefSeq transcripts estimated and belong to same genes as a Refseq gene
UNRELATED		0		All other transcripts
MISSING			287		transcripts simulated that were not estimated
*/
