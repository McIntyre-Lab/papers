...
proc export data=xscripts_all2
     outfile="!MCLAB/event_analysis/analysis_output/event_analysis_transcripts_for_comparison.csv" dbms=csv replace;
run;

/* Export data for making plots to look at transcript binning */

proc export data=event.xscripts_w_unique_by_bin
     outfile="!MCLAB/event_analysis/analysis_output/event_analysis_transcripts_by_perc_unique_detected.csv" dbms=csv replace;
run;
