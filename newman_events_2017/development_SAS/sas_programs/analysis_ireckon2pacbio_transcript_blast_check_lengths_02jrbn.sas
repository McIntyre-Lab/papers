...
data match_flags;
   ...
   /* match and ref within 75% of total length of ref */
   if hit_length/transcript_seq_length ge 0.75 and flag_has_mismatch = 0
   then flag_len_match_75prc_ref=1;
   else flag_len_match_75prc_ref=0;

   /* match and ref within 75% of total length of ref -- with mismatches */
   if hit_length/transcript_seq_length ge 0.75 and flag_has_mismatch = 1
   and flag_mismatch_gt5=0 then flag_len_match_75prc_ref_mm5=1;
   else flag_len_match_75prc_ref_mm5=0;

   /* match and ref within 50% of total length of ref */
   if hit_length/transcript_seq_length ge 0.5 and flag_has_mismatch = 0
   then flag_len_match_50prc_ref=1;
   else flag_len_match_50prc_ref=0;

   /* match and ref within 50% of total length of ref -- with mismatches */
   if hit_length/transcript_seq_length ge 0.5 and flag_has_mismatch = 1
   and flag_mismatch_gt5=0 then flag_len_match_50prc_ref_mm5=1;
   else flag_len_match_50prc_ref_mm5=0;
...
%extractHits(match_flags10,flag_len_match_90prc_ref_mm5,match_90perc_mm5,match_flags11);
* 16 hits;


%extractHits(match_flags11,flag_len_match_75prc_ref,match_75perc,match_flags12);
* 264 hits;

%extractHits(match_flags12,flag_len_match_75prc_ref_mm5,match_75perc_mm5,match_flags13);
* 14 hits;

%extractHits(match_flags13,flag_len_match_50prc_ref,match_50perc,match_flags14);
* 136 hits;

%extractHits(match_flags14,flag_len_match_50prc_ref_mm5,match_50perc_mm5,no_hits);
* 23 hits;
* in total 3591 "non-hits";
...
data event.ireckon2pacbio_blast_best;
   set true_hit true_hit_mm5 complete_hit complete_hit_mm5
       ...
       match_75perc match_75perc_mm5
       match_50perc match_50perc_mm5;
run;
...
sample    blast_hit_flag                      COUNT    PERCENT
  NSC1     flag_len_match_10bp_diff_ref           12     0.6039
  NSC1     flag_len_match_10bp_diff_ref_mm5        1     0.0503
  NSC1     flag_len_match_50prc_ref               78     3.9255
  NSC1     flag_len_match_50prc_ref_mm5            4     0.2013
  NSC1     flag_len_match_5bp_diff_ref            43     2.1641
  NSC1     flag_len_match_5bp_diff_ref_mm5         2     0.1007
  NSC1     flag_len_match_75prc_ref              160     8.0523
  NSC1     flag_len_match_75prc_ref_mm5            4     0.2013
  NSC1     flag_len_match_90prc_ref              311    15.6517
  NSC1     flag_len_match_90prc_ref_mm5            8     0.4026
  NSC1     flag_len_match_eq_ref                1352    68.0423
  NSC1     flag_len_match_eq_ref_mm5              11     0.5536
  NSC1     flag_len_query_eq_ref                   1     0.0503
...
/*
  ...
  -----------------------------------------------------------
  NSC1          1987       59.44          1987        59.44
  NSC2          1356       40.56          3343       100.00
