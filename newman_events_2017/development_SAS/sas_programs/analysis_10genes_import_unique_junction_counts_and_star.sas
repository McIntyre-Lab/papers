...
proc import datafile="/mnt/store/event_sandbox/polyester_simulated_data/10genes_nic/aln_mm10_star_10genes_nic_simulation/&sample.SJ.out.tab"
...
%macro importCC(sample);
    ...
    infile "/mnt/store/event_sandbox/polyester_simulated_data/10genes_nic/coverage_counts_splicing_10genes_nic/cvrg_cnts_&sample..csv" delimiter
...
data event.star_junctions_10genes;
   set star_juncs;
run;

data event.catalog_junctions_10genes;
