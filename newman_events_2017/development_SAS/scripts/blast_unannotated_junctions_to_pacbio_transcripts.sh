...
## BLAST detected unannotated junctions against PacBio transcript sequences

PROJ=$MCLAB/event_analysis

INPUT=$PROJ/references/unannotated_junctions_detected_npc.fa
...
OUTPUT1=$OUTDIR/blast_unannotated_junctions_to_pacbio_basic.tsv
OUTPUT2=$OUTDIR/blast_unannotated_junctions_to_pacbio_min_length_50.tsv
