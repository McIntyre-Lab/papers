...
proc export data=induced
            outfile= '/home/jfear/mclab/arbeitman/arbeitman_fru_network/exported_data_from_michelle/FruM_B_male_ind_1fold_jmf.tab'
            dbms=CSV replace;
            putnames=no;
            run;

proc export data=repressed
            outfile= '/home/jfear/mclab/arbeitman/arbeitman_fru_network/exported_data_from_michelle/FruM_B_male_rep_1fold_jmf.tab'
            dbms=CSV replace;
            putnames=no;
            run;

data FRU.fruB_male_fus_ind_rep_nfold;
    set merged2;
    rename flag_induced = flag_fruB_male_ind_nofold;
    rename flag_repressed = flag_fruB_male_rep_nofold;
    keep fusion_id flag_induced flag_repressed;
    run;

proc export data=FRU.fruB_male_fus_ind_rep_nfold
            outfile= '/home/jfear/mclab/arbeitman/arbeitman_fru_network/reports_external/FruM_B_male_flag_ind_rep_nofold.csv'
            dbms=CSV replace;
            putnames=yes;
            run;
