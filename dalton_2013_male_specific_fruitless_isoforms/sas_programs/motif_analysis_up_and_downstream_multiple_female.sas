...
data fru.fru_multi_test_up_down_female;
...
%macro export_analysis(letter,outdir);
    ...
    %macro response_type(type);
        ...
        proc export data=fru_&letter._&type._multi_motif 
                    outfile="&outdir./fru_&letter._&type._multi_motif_table_up_and_down_female.csv" 
...
proc export data=fru.fru_multi_test_up_down_female 
            outfile="!MCLAB/arbeitman_fru_network/reports_internal/motif_analysis/motif_results_up_and_down/fru_multi_motif_tests_up_and_down_female.csv" 
            dbms=CSV replace label;
    putnames=yes;
    run;
